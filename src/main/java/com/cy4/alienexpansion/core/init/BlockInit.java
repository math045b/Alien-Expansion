...
public class BlockInit {
	...
	public static final RegistryObject<Block> SIMPLE_ALIEN_RUNE_ACTIVE = BLOCKS.register("simple_alien_rune_active", () -> new Block(PropertyInit.LIT_ALIEN_BLOCK));
	...
	public static final RegistryObject<Block> ADVANCED_ALIEN_RUNE_ACTIVE = BLOCKS.register("advanced_alien_rune_active", () -> new Block(PropertyInit.LIT_ALIEN_BLOCK));
}