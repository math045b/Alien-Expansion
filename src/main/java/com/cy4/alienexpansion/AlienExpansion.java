...
@Mod("alienexpansion")
@Mod.EventBusSubscriber(modid = AlienExpansion.MOD_ID, bus = Bus.MOD)
public class AlienExpansion
{
    public static final Logger LOGGER = LogManager.getLogger();
    public static final String MOD_ID = "alienexpansion";
    public static AlienExpansion instance;

    public AlienExpansion() {
	...
	@Mod.EventBusSubscriber(modid = AlienExpansion.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD)
	class RegistryEvents {
		...
		private <T extends IForgeRegistryEntry<T>> T setup(@Nonnull final T entry, @Nonnull final String name) {
			...
			return setup(entry, new ResourceLocation(AlienExpansion.MOD_ID, name));
		}
		@Nonnull
